...
enum {
	...
	BD7181X_REG_INT_EN_02,
	BD7181X_REG_INT_EN_03,
	BD7181X_REG_INT_EN_04,
	BD7181X_REG_INT_EN_05,
	BD7181X_REG_INT_EN_06,
	BD7181X_REG_INT_EN_07,
	BD7181X_REG_INT_EN_08,
	BD7181X_REG_INT_EN_09,
	BD7181X_REG_INT_EN_10,
	// 0x95
	...
	// 0xB0
	BD7181X_REG_RESERVE_0		= 0xB0,
	BD7181X_REG_RESERVE_1,
	BD7181X_REG_RESERVE_2,
	BD7181X_REG_RESERVE_3,
	BD7181X_REG_RESERVE_4,
	BD7181X_REG_RESERVE_5,
	BD7181X_REG_RESERVE_6,
	BD7181X_REG_RESERVE_7,
	BD7181X_REG_RESERVE_8,
	BD7181X_REG_RESERVE_9,
...
/* BD71805_REG_INT_STAT_1 bits */
#define LED_SCP					0x80
#define LED_OCP					0x40
#define LED_OVP					0x20
#define BUCK5FAULT				0x10
#define BUCK4FAULT				0x08
#define BUCK3FAULT				0x04
#define BUCK2FAULT				0x02
#define BUCK1FAULT				0x01

/* BD71805_REG_INT_STAT_2 bits */
#define DCIN_OV_DET				0x20
#define DCIN_OV_RES				0x10
#define DCIN_CLPS_IN			0x08
#define DCIN_CLPS_OUT			0x04
#define DCIN_RMV				0x02

/* BD71805_REG_INT_STAT_3 bits */
#define DCIN_MON_DET			0x02
#define DCIN_MON_RES			0x01

/* BD71805_REG_INT_STAT_4 bits */
#define VSYS_MON_DET			0x80
#define VSYS_MON_RES			0x40
#define VSYS_LO_DET				0x08
#define VSYS_LO_RES				0x04
#define VSYS_UV_DET				0x02
#define VSYS_UV_RES				0x01

/* BD71805_REG_INT_STAT_5 bits */
#define CHG_TRNS				0x80
#define TMP_TRNS				0x40
#define BAT_MNT_IN				0x20
#define BAT_MNT_OUT				0x10
#define CHG_WDT_EXP				0x08
#define EXTEMP_TOUT				0x04
#define INHIBIT_0				0x01

/* BD71805_REG_INT_STAT_6 bits */
#define TH_DET					0x80
#define TH_RMV					0x40
#define BAT_DET					0x20
#define BAT_RMV					0x10
#define TMP_OUT_DET				0x02
#define TMP_OUT_RES				0x01

/* BD71805_REG_INT_STAT_7 bits */
#define VBAT_OV_DET				0x80
#define VBAT_OV_RES				0x40
#define VBAT_LO_DET				0x20
#define VBAT_LO_RES				0x10
#define VBAT_SHT_DET			0x08
#define VBAT_SHT_RES			0x04
#define VBAT_DBAT_DET				0x02

/* BD71805_REG_INT_STAT_8 bits */
#define VBAT_MON_DET			0x02
#define VBAT_MON_RES			0x01

/* BD71805_REG_INT_STAT_9 bits */
#define CC_MON3_DET				0x04
#define CC_MON2_DET				0x02
#define CC_MON1_DET				0x01

/* BD71805_REG_INT_STAT_10 bits */
#define OCUR3_DET				0x20
#define OCUR3_RES				0x10
#define OCUR2_DET				0x08
#define OCUR2_RES				0x04
#define OCUR1_DET				0x02
#define OCUR1_RES				0x01
...
/* BD7181X enable interrupt masks */
 enum {
	BD7181X_INT_EN_01_BUCKAST_MASK	=	0x00,
	BD7181X_INT_EN_02_DCINAST_MASK	=	0x00, //0x3E, // DCIN CONNECT/REMOVE & COLAPSE
	BD7181X_INT_EN_03_DCINAST_MASK	=	0x00, // TO AVOID CABLE JOGGLING WHEN CLOSE TO COLAPSE
	BD7181X_INT_EN_04_VSYSAST_MASK	=	0x00,
	BD7181X_INT_EN_05_CHGAST_MASK	=	0x00,
	BD7181X_INT_EN_06_BATAST_MASK	=	0x00,
	BD7181X_INT_EN_07_BMONAST_MASK	=	0x00,
	BD7181X_INT_EN_08_BMONAST_MASK	=	0x00, // 0x02, // SIGTERM VBAT LOW
	BD7181X_INT_EN_09_BMONAST_MASK	=	0x00,
	BD7181X_INT_EN_10_BMONAST_MASK	=	0x00,
	BD7181X_INT_EN_11_TMPAST_MASK	=	0x00,
	BD7181X_INT_EN_12_ALMAST_MASK	=	0x00,
};
