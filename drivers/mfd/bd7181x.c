...
static struct resource power_resources[] = {
	{
		.name   = "IRQ_BUCK_01",
		.start	= BD7181X_IRQ_BUCK_01,
		.end	= BD7181X_IRQ_BUCK_01,
		.flags	= IORESOURCE_IRQ,
	},
	{
		.name   = "IRQ_DCIN_02",
		.start	= BD7181X_IRQ_DCIN_02,
		.end	= BD7181X_IRQ_DCIN_02,
		.flags	= IORESOURCE_IRQ,
	},
	{
		.name   = "IRQ_DCIN_03",
	...
	{
		.name   = "IRQ_VSYS_04",
		.start	= BD7181X_IRQ_VSYS_04,
		.end	= BD7181X_IRQ_VSYS_04,
		.flags	= IORESOURCE_IRQ,
	},
	{
		.name   = "IRQ_CHARGE_05",
	...
	{
		.name   = "IRQ_BAT_06",
		.start	= BD7181X_IRQ_BAT_06,
		.end	= BD7181X_IRQ_BAT_06,
		.flags	= IORESOURCE_IRQ,
	},
	{
		.name   = "IRQ_BAT_MON_07",
		.start	= BD7181X_IRQ_BAT_MON_07,
		.end	= BD7181X_IRQ_BAT_MON_07,
		.flags	= IORESOURCE_IRQ,
	},
	// irq# 1
	{
	...
	{
		.name   = "IRQ_BAT_MON_09",
		.start	= BD7181X_IRQ_BAT_MON_09,
		.end	= BD7181X_IRQ_BAT_MON_09,
		.flags	= IORESOURCE_IRQ,
	},
	{
		.name   = "IRQ_BAT_MON_10",
		.start	= BD7181X_IRQ_BAT_MON_10,
		.end	= BD7181X_IRQ_BAT_MON_10,
		.flags	= IORESOURCE_IRQ,
	},
	{
		.name   = "IRQ_TEMPERATURE_11",
